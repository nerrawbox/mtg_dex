...
class CardOracleResult {
  String? object;
  int? totalCards;
  bool? hasMore;
  List<CardOracle>? data;
  ...
  factory CardOracleResult.fromRawJson(String str) =>
      CardOracleResult.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory CardOracleResult.fromJson(Map<String, dynamic> json) =>
      CardOracleResult(
        object: json["object"],
        ...
        data: json["data"] == null
            ? []
            : List<CardOracle>.from(
                json["data"]!.map((x) => CardOracle.fromJson(x))),
      );
...
class CardOracle {
  ...
  factory CardOracle.fromRawJson(String str) =>
      CardOracle.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory CardOracle.fromJson(Map<String, dynamic> json) => CardOracle(
        object: json["object"],
        id: json["id"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "produced_mana": producedMana == null
            ? []
            : List<dynamic>.from(producedMana!.map((x) => x)),
